...
function drawAsteroids(spriteBatch, texture) {
    for (var i = astlen - 1; i >= 0; i--) {
        ...
        //spriteBatch.draw(texture, x, y, null, texture.width / 2, texture.height / 2, angle, scale, scale, alpha, alpha, alpha, alpha);

        //pos[0] = x;
        //pos[1] = y;
        //orig[0] = texture.width / 2;
        //orig[1] = texture.height / 2;
        //sc[0] = scale;
        //sc[1] = scale;
        //cl[0] = alpha;
        //cl[1] = alpha;
        ...
        //cl[3] = alpha;
        ////
        //spriteBatch.draw(texture, pos, null, orig, angle, sc, cl);
...
var MobileGame = Game.extend({
    ...
    update: function(gameTime) {
        //addAsteroid();
        //updateAsteroids(gameTime.elapsedGameTime / 1000);
    ...
    draw: function(gameTime) {
        ...
        //this.graphicsDevice.clear([1, 1, 1, 1]);
